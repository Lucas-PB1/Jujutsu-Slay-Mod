# Jujutsu Kaisen: Rigorous Card Implementation Checklist

---

## 1. Fundamentals & Itadori Base
- [x] **Strike** (Starter)
- [x] **Defend** (Starter)
...
- [ ] **Judgeman's Evidence** (Skill - Uncommon)
- [ ] **Verdict: Confiscation** (Skill - Rare)
- [ ] **Verdict: Death Penalty** (Skill - Rare)
- [ ] **Executioner's Sword** (Attack - Special)
- [ ] **Gavel: Shape-shift** (Skill - Common)
- [ ] **Retrial Request** (Skill - Uncommon)

### Kokichi Muta: Mechamaru Arsenal
- [ ] **Mode: Absolute** (Power - Rare)
- [ ] **Energy Storage** (Power/Status - Uncommon)
- [ ] **Cursed Bullet Shot** (Attack - Common)
- [ ] **Ultra Cannon** (Attack - Uncommon)
- [ ] **Ultimate Cannon** (Attack - Rare)
- [ ] **Pigeon Viola** (Attack - Uncommon)
...
- [ ] **Collapse (Garagara)** (Attack - Rare)
- [ ] **Binding Vow: Overtime** (Power - Uncommon)

### Nobara Kugisaki: Straw Doll
- [ ] **Resonance** (Attack - Uncommon)
- [ ] **Hairpin Detonation** (Attack - Common)

### Toge Inumaki: Cursed Speech
- [ ] **Command: Don't Move** (Skill - Uncommon)
- [ ] **Command: Sleep** (Skill - Uncommon)
- [ ] **Command: Explode** (Attack - Rare)
- [ ] **Command: Get Twisted** (Attack - Uncommon)
- [ ] **Command: Get Crushed** (Attack - Rare)
- [ ] **Command: Blast Away** (Attack - Uncommon)
- [ ] **Command: Return** (Skill - Common)

### Panda: Cores
- [ ] **Panda Core** (Power - Starter)
- [ ] **Gorilla Core** (Power - Uncommon)
...
## 4. Barrier Arts & Anti-Domain
- [ ] **Simple Domain** (Skill - Common)
- [ ] **Hollow Wicker Basket** (Skill - Uncommon)
- [ ] **Falling Blossom Emotion** (Power - Uncommon)
- [ ] **Domain Amplification** (Power - Rare)
